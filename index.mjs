...
(async()=>{
   ...
   // console.log('single >> '+singleBrand)
    ...
    console.log('\n\n>>>>>>> DUAL WORDS AND MORE, down here');

    console.log('2 letter brands >> '+ dualMoreWords_twoLetterBrand+'\n')
    console.log('3 letter brands >> '+ dualMoreWords_thirdLetterBrand+'\n')
    console.log('4 letter brands >> '+ dualMoreWords_fourLetterBrand+'\n')
    console.log('5 letter brands >> '+ dualMoreWords_fiveLetterBrand+'\n')
    console.log('6 letter brands >> '+ dualMoreWords_sixLetterBrand+'\n')
    console.log('7 letter brands >> '+ dualMoreWords_sevenLetterBrand+'\n')
    console.log('8 letter brands >> '+ dualMoreWords_eightLetterBrand+'\n')
    console.log('9 letter brands >> '+ dualMoreWords_nineLetterBrand+'\n')
    console.log('10 letter brands >> '+ dualMoreWords_tenLetterBrand+'\n')
    console.log('11 letter brands >> '+ dualMoreWords_elevenLetterBrand+'\n')
    console.log('12 letter brands >> '+ dualMoreWords_twelveLetterBrand+'\n')
    console.log('13 letter brands >> '+ dualMoreWords_13thLetterBrand+'\n')
    console.log('14 letter brands >> '+ dualMoreWords_14thLetterBrand+'\n')
    console.log('15 letter brands >> '+ dualMoreWords_15thLetterBrand+'\n')
    console.log('16 letter brands >> '+ dualMoreWords_16thLetterBrand+'\n')
    console.log('17 letter brands >> '+ dualMoreWords_17thLetterBrand+'\n')
    console.log('18 letter brands >> '+ dualMoreWords_18thLetterBrand+'\n')
    console.log('19 letter brands >> '+ dualMoreWords_19thLetterBrand+'\n')
    console.log('20 letter brands >> '+ dualMoreWords_20thLetterBrand+'\n')
    console.log('21 letter brands >> '+ dualMoreWords_21thLetterBrand+'\n')
    console.log('22 letter brands >> '+ dualMoreWords_22thLetterBrand+'\n')
    console.log('23 letter brands >> '+ dualMoreWords_23thLetterBrand+'\n')
    console.log('24 letter brands >> '+ dualMoreWords_24thLetterBrand+'\n')
    console.log('25 letter brands >> '+ dualMoreWords_25thLetterBrand+'\n')
    console.log('26 letter brands >> '+ dualMoreWords_26thLetterBrand+'\n')
    console.log('27 letter brands >> '+ dualMoreWords_27thLetterBrand+'\n')
    console.log('28 letter brands >> '+ dualMoreWords_28thLetterBrand+'\n')
    console.log('29 letter brands >> '+ dualMoreWords_29thLetterBrand+'\n')
    //console.log('13 letter brands >> '+ dualMoreWords_30+'\n')
    // console.log('5 letter brands >> '+ fiveLetterBrand)
    // console.log('6 letter brands >> '+ sixLetterBrand)
